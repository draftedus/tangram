...
fn main() -> Result<()> {
	...
	let model = tangram::tree::MulticlassClassifier::train(
		features_train,
		labels_train.clone(),
		train_options,
		&mut |_| {},
	...
	// compute metrics
	let mut metrics = tangram::metrics::ClassificationMetrics::new(100);
	metrics.update(tangram::metrics::ClassificationMetricsInput {
