...
let globalCss = `body { background-color: var(--background); color: var(--text); font-family: JetBrains Mono, monospace, sans-serif; margin: 0; line-height: 1; } @font-face { font-family: "JetBrains Mono"; src: url("/jetbrainsmono.woff2") format("woff2"); font-display: swap; } a, button { outline: none } :root {--border-radius: 4px; --border-width: 2px;--max-width: 1200px;--min-width: 256px--border: 2px solid #F2F2F2;--border-color: #F2F2F2;	--blue: #0A84FF;	--gray: #8E8E93;	--green: #30D158;	--indigo: #5e5ce6;	--orange: #FF9F0A;	--pink: #FF375F;	--purple: #BF5AF2;	--red: #FF453A;	--teal: #4DD0E1;	--yellow: #FFD60A;	--background: #FFFFFF; --border: #F2F2F2; --header: #EEEEEE; --hover: #CCCCCC; --surface: #FAFAFA; --muted-text: #666666; --text: #222222; --accent: #0A84FF; --fun-text: #ffffff } @media (prefers-color-scheme: dark) { :root { --background: #111111; --border-color: #212121; --border: 2px solid #212121; --header: #232323; --hover: #333333; --surface: #181818; --muted-text: #8B8B8B; --text: #E8E8E8; --accent: #0A84FF; --fun-text: #111111} }`
