		...
		<ui.S1>
			...
			<ui.S2>
				...
				<ui.P>
					...
					app. In the topbar, click <b>Tokens</b>.
				</ui.P>
			...
			<ui.S2>
				...
				<ui.P>
					...
					send all logs to the server in a single request, you can flush the
					queue.
				</ui.P>
			...
			<ui.S2>
				...
				<ui.P>
					Here, we see that the <ui.InlineCode>chest_pain</ui.InlineCode> column
					has an alert and a high unknown values count. Let's select it.
				</ui.P>
				<ui.Img alt="unknown values" src={productionColumnStatsUnknownValues} />
				<ui.P>
					In the unknown values table, we see that there are a large number of
					inputs with the unknown value <ui.InlineCode>asx</ui.InlineCode>.
				</ui.P>
				<ui.Img alt="unique values" src={productionColumnStatsUniqueValues} />
				<ui.P>
					<ui.InlineCode>asx</ui.InlineCode> is a common medical abbreviation
					for <ui.InlineCode>asymptomatic</ui.InlineCode> so it looks like
					<ui.InlineCode>asymptomatic</ui.InlineCode> is mislabeled as{' '}
					<ui.InlineCode>asx</ui.InlineCode> in production. We can fix this by
					mapping <ui.InlineCode>asx</ui.InlineCode> to{' '}
					<ui.InlineCode>asymptomatic</ui.InlineCode> in our code. That fix
			...
			<ui.S2>
				...
				<ui.P>
					Under <b>Production Metrics</b> we can ensure our model is as accurate
				...
				<ui.P>
					...
					<ui.InlineCode>asymptomatic</ui.InlineCode> as{' '}
					<ui.InlineCode>asx</ui.InlineCode>. To support this theory, let's see
					how important this feature was to our model.
				</ui.P>
				<ui.P>
					Under <b>Model</b>, we can view feature and column importances. The
					<ui.InlineCode>chest_pain=asymptomatic</ui.InlineCode> feature is by
					far the most important to our model, so it makes sense that
					mislabeling <ui.InlineCode>asymptomatic</ui.InlineCode> as{' '}
					<ui.InlineCode>asx</ui.InlineCode> would cause a drop in accuracy.
				</ui.P>
