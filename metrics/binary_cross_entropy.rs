...
/// BinaryCrossEntropy is the loss function used for Binary Classifiers. https://en.wikipedia.org/wiki/Cross_entropy#Cross-entropy_loss_function_and_logistic_regression.
